...
func TestSignUp_Success(t *testing.T) {
	...
	u, err := svc.SignUp(context.Background(), "user@x.com", "pwd1234")
...
func TestLogin_Success(t *testing.T) {
	...
	token, err := svc.Login(context.Background(), "user@x.com", "correct")
	assert.NoError(t, err)
...
func TestLogin_Invalid(t *testing.T) {
	...
	token, err := svc.Login(context.Background(), "user@x.com", "pwd")
	assert.Error(t, err)
...
func TestGetProfile(t *testing.T) {
	...
	u, err := svc.GetProfile(context.Background(), 3)
	assert.NoError(t, err)
...
func TestUpdateUser_Success(t *testing.T) {
	...
	u, err := svc.UpdateUser(context.Background(), 1, "New")
	assert.NoError(t, err)
...
func TestUpdateUser_NotFound(t *testing.T) {
	...
	mr.On("GetByID", mock.Anything, int64(2)).Return(nil, fmt.Errorf("not found"))

	u, err := svc.UpdateUser(context.Background(), 2, "New")
	assert.Error(t, err)
	assert.Nil(t, u)
